...
public interface PersonalScheduleDocs {
    ...
    ResponseEntity<PersonalScheduleResponseDto> addPersonalSchedule(
    ...
    ResponseEntity<List<ScheduleDetailResponseDto>> getPersonalSchedules();
    ...
    ResponseEntity<Map<String, Boolean>> updatePersonalSchedule(
    ...
    ResponseEntity<List<ScheduleDetailResponseDto>> getPersonalSchedulesByMemberId(
    ...
    ResponseEntity<Map<String, Boolean>> deletePersonalSchedule(
